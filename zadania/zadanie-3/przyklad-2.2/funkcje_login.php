<?php
    ...
    function sprawdz_uzytkownika(&$user_db)
    {
        ...
        $zapytanie = "SELECT * FROM uzytkownicy WHERE login='$login_form'";
        $user = mysqli_query($polaczenie, $zapytanie)
    ...
    function zweryfikuj_haslo($user_db)
    {
        ...
        if ($user_db)
            ...
            else echo "<p>Logowanie nieudane. Podano złe hasło!</p>";
        else echo "<p>Brak podanego użytkownika: $login_form</p>";
    }