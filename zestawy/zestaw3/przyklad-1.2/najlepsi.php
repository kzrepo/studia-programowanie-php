...
<?php
    ...
    $column_name = 'nazwisko, imie, miasto, data_ur, wydzial, swiadectwo, mat, fiz, jezyk, swiadectwo+mat+fiz+jezyk AS suma';
    $zapytanie2 = "SELECT $column_name FROM egzamin WHERE wydzial='$wydz' ORDER BY suma DESC, nazwisko ASC"
