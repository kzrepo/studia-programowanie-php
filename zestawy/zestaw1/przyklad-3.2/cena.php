<!--
Napisz również funkcje sprawdzające czy podano poprawne dane (czy jest
liczbą, czy dodatnią itp.) osobno dla ceny i vat-u (np. czy mieści się w
przedziale od 0 do 100%). Wywołaj je w odpowiednim miejscu kodu.
Zadbaj o estetykę strony. Zwróć uwagę, że przy pierwszym wejściu na
stronę wiersz z wynikiem w ogóle się nie wyświetla.
-->
    ...
    <table>
        ...
        <?php
            if (isset($_GET['brutto']))
            {
                ...
                if (empty($wynik))
                    $wynik = "Cena netto: " . number_format(oblicz_netto($brutto, $vat), 2, ',', " ") . " zł";
