<!--
Spróbuj zmodyfikować funkcję netto z ćwiczenia 3.1 dodając trzeci
argument $netto przekazywany przez referencję. Użyj go do
przekazania wyniku z funkcji (zamiast instrukcji return)
-->

<?php
    function oblicz_netto($brutto, $vat, &$netto)
    {
